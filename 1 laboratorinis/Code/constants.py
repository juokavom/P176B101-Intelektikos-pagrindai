...
# ----
CATEGORICAL_OUTPUT_PATH = OUTPUT_FOLDER_NAME + "/kategorinių_duomenų_analizė.csv"
CATEGORICAL_OUTPUT_HEADER_NAMES = ['Atributo pavadinimas', 'Kiekis (Eilučių sk.)', 'Trūkstamos reikšmės, %',
                                   'Kardinalumas', 'Moda', 'Modos dažnumas', 'Moda, %', '2-oji moda',
                                   '2-osios Modos dažnumas', '2-oji Moda, %']
CONTINUOUS_OUTPUT_PATH = OUTPUT_FOLDER_NAME + "/tolydinių_duomenų_analizė.csv"
CONTINUOUS_OUTPUT_HEADER_NAMES = ['Atributo pavadinimas', 'Kiekis (Eilučių sk.)', 'Trūkstamos reikšmės, %',
